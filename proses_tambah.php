...
$query = $con->prepare("INSERT INTO kendaraan (jenis, merk, warna, tahun, bbm, nopol, norangka, nomesin, pemilik, alamat, gambar) 
                        VALUES (:jenis, :merk, :warna, :tahun, :bbm, :nopol, :norangka, :nomesin, :pemilik, :alamat, :gambar)");
